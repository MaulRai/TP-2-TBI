...
class InvertedIndex:
    ...
    def __init__(self, index_name, postings_encoding, directory=''):
        ...
        self.term_max_score = {} # key: termID, value: UB (Upper Bound) score BM25 untuk WAND
    ...
    def __enter__(self):
        ...
        with open(self.metadata_file_path, 'rb') as f:
            self.postings_dict, self.terms, self.doc_length, self.term_max_score = pickle.load(f)
    ...
    def __exit__(self, exception_type, exception_value, traceback):
        ...
        with open(self.metadata_file_path, 'wb') as f:
            pickle.dump([self.postings_dict, self.terms, self.doc_length, self.term_max_score], f)
